...
//       toolbar_tab.setupWithViewPager(main_vp_container);
        ...
        Glide.with(this).load(R.drawable.fuyuanai).bitmapTransform(new RoundedCornersTransformation(this,
                10, 0)).into(head_iv);
    }
    ...
    private void loadBlurAndSetStatusBar() {
        ...
        Glide.with(this).load(R.drawable.fuyuanai).bitmapTransform(new BlurTransformation(this, 100))
